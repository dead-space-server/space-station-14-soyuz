...
public sealed class MOTDSystem : EntitySystem
{
    ...
    /// </summary>
    private string _messageOfTheDay = "На данный момент, ведётся набор в команду администрации проекта 'Мёртвый Космос'! Роль которую мы вам предлагаем - 'Младший Ивент Мастер'. Вы сможете реализовать свой творческий потенциал, возможность подниматься выше по должностям, а так же, админ-ранг, за который вы можете бесплатно получить платные-привилегии. Ивентерам Союз-1 так же выдаётся достаточно приятная и качественная помощь в организации и проведении ивентов. Если вас заинтересовала возможность реализации своих идей - пишите в канал 'наборы' на нашем дискорд сервере!";
