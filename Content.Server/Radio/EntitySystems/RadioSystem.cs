...
public sealed class RadioSystem : EntitySystem
{
    ...
    {
        { "fcdf03", ["командование", "кэп", "капитан", "начальника отдела кадров"] },
        { "d98b71", ["юридический отдел", "судья", "юрист"] },
        { "dd3535", ["милиция", "бриг", "варден", "смотритель", "инструктор", "следователь", "пилот сб", "бригмед", "кадет"] },
        { "57b8f0", ["медицинский отдел", "главный врач", "ведущий врач", "химик", "врач", "парамед", "коронер", "психиатр", "интерн"] },
        { "c68cfa", ["научный отдел", "рнд", "нио", "научный сотрудник", "ведущий учёный", "учёный", "робоёб", "лаборант", "анома"] },
        { "f2ac26", ["инженерный отдел", "инженерный", "старший инженер", "ведущий инженер", "атмосферный техник", "атмос", "инженер", "инженер стажёр"] },
        { "a46106", ["отдел почты", "почта", "каргонцы", "ведущий шахтёр", "ведущий шахтёр", "шахтёр", "грузчик"] },
        { "6ca729", ["сервисный отдел", "сервис", "управляющий", "шеф", "повар", "ботаник", "бармен", "боксер", "уборщик", "библиотекарь", "священик", "святой отец", "зоотехник", "репортёр", "музыкант"] },        { "2ed2fd", ["искусственный интеллект", "юнит", "борг"] },
        { "fb77f3", ["клуня", "клоун"] },
        { "d0d0d0", ["мим"] }
    };
