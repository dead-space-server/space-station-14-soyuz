...
public sealed class RadioSystem : EntitySystem
{
    ...
    {
        { "fcdf03", ["командование", "кэп", "капитан", "начальник отдела кадров"] },
        { "d98b71", ["юридический отдел", "судья", "юрист", "агент следственного комитета"] },
        { "dd3535", ["милиция", "участок", "оперативный дежурный", "старший милиционер", "следователь", "пилот милиции", "дежурный врач", "младший милиционер"] },
        { "57b8f0", ["медицинский отдел", "главный врач", "врач-методист", "химик", "врач", "фельдшер", "патологоанатом", "психолог", "интерн"] }, // DS14-Soyuz
        { "c68cfa", ["научный отдел", "научно-исследовательский отдел", "рнд", "нио", "научный сотрудник", "старший научный сотрудник", "научный сотрудник", "робоёб", "младший научный сотрудник", "анома"] },
        { "f2ac26", ["инженерный отдел", "инженерный", "старший инженер", "бригадир", "атмосферный техник", "атмос", "инженер", "слесарь"] },
        { "a46106", ["отдел почты", "почта", "каргонцы", "ведущий шахтёр", "шахтёр", "грузчик"] },
        { "6ca729", ["сервисный отдел", "обслуживающий отдел", "сервис", "управляющий", "шеф", "повар", "агроном", "бармен", "боксер", "уборщик", "библиотекарь", "священик", "святой отец", "ветеринар", "репортёр", "музыкант"] },
