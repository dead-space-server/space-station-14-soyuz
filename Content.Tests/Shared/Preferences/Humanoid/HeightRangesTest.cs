...
public sealed class HeightRangesTest
{
    ...
    [TestCase("Vulpkanin", Sex.Female, 158, 175, 215)]
    [TestCase("Vulpkanin", Sex.Male, 158, 185, 220)]
    [TestCase("Dwarf", Sex.Male, 146, 150, 160)]
    [TestCase("Diona", Sex.Male, 170, 180, 210)]
    [TestCase("Kobolt", Sex.Male, 140, 150, 160)]
    [TestCase("IPC", Sex.Unsexed, 175, 185, 185)]
    [TestCase("Xenomorph", Sex.Unsexed, 180, 210, 220)]
    [TestCase("Human", Sex.Male, 160, 180, 200)]
    [TestCase("Moth", Sex.Male, 150, 175, 190)]
    [TestCase("Shark", Sex.Male, 175, 205, 215)]
    [TestCase("SlimePerson", Sex.Male, 160, 170, 210)]
    [TestCase("Tajaran", Sex.Male, 160, 170, 190)]
    [TestCase("Reptilian", Sex.Male, 190, 180, 200)]
