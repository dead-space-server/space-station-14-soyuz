...
public sealed class HeightRangesTest
{
    ...
    [TestCase("Demon", Sex.Female, 160, 178, 210)]
    [TestCase("Demon", Sex.Male, 170, 190, 220)]
    [TestCase("Vox", Sex.Unsexed, 140, 150, 180)]
    [TestCase("Vulpkanin", Sex.Female, 160, 175, 215)]
    [TestCase("Vulpkanin", Sex.Male, 160, 185, 220)]
    [TestCase("Dwarf", Sex.Male, 145, 150, 160)]
    [TestCase("Diona", Sex.Male, 170, 180, 210)]
    [TestCase("Kobolt", Sex.Male, 140, 150, 160)]
    [TestCase("IPC", Sex.Unsexed, 175, 180, 185)]
    [TestCase("Xenomorph", Sex.Unsexed, 180, 210, 220)]
    [TestCase("Human", Sex.Male, 150, 180, 200)]
    [TestCase("Moth", Sex.Male, 140, 175, 190)]
    [TestCase("Shark", Sex.Male, 175, 205, 215)]
    [TestCase("SlimePerson", Sex.Male, 150, 170, 210)]
    [TestCase("Tajaran", Sex.Male, 150, 170, 190)]
    [TestCase("Reptilian", Sex.Male, 165, 180, 200)]
