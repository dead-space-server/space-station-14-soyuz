cmd-delaystart-desc = Adjusts the round start timer (accepts positive and negative integers).
...
cmd-delaystart-too-late = Round start could not be adjusted in time!
