...
roles-antag-syndicate-agent-name = Contracted agent
roles-antag-syndicate-agent-objective = Complete your objectives without being caught.

roles-antag-syndicate-agent-sleeper-name = Sleeper contracted agent
roles-antag-syndicate-agent-sleeper-objective = A form of contracted agent that can activate at any point in the middle of the shift.
