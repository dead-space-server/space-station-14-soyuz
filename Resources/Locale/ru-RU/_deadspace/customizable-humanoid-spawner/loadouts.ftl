spawner-loadout-blueshield = Оперативник КГБ, спавнер
...
spawner-loadout-centcomm-administrator = Администратор ГШ, спавнер
spawner-loadout-centcomm-operator = Оператор ГШ, спавнер
