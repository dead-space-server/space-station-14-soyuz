...
ert-response-caused-messager-official =
    ...
    В связи с необходимостью, Секторальный Штаб ЦК принял решение об отправке Представителя Генерального Штаба
    на ваш актив, для проведения разбирательств. Ожидайте прибытия в ближайшее время. Слава СССП!
