...
virus-evolution-health = Здоровье: { $current }/{ $max }
virus-evolution-infectivity = Заразность: { $percent }%
virus-evolution-infected-count = Заражённых: { $count }
virus-evolution-points-per-second = Очков/сек: { $points }
...
virus-evolution-virusdata-missing = Данные об вирусе не найдены
virus-evolution-dataserver-missing = Сервер данных или анализатор веществ не подключён
virus-evolution-dataserver-far = Сервер данных или анализатор веществ слишком далеко

### SOLUTION ANALYZER STATES (на будущее) ###

virus-evolution-solution-analyzer-missing = Анализатор растворов не подключён
virus-evolution-solution-analyzer-far = Анализатор растворов слишком далеко

### BUTTON / ACTION ERRORS (если понадобятся) ###

virus-evolution-not-enough-points = Недостаточно очков мутации
virus-evolution-no-selection = Ничего не выбрано

### TOOLTIP / INFO ###

virus-evolution-symptom-price-tooltip = Базовая цена: { $price }
virus-evolution-body-price-tooltip = Стоимость тела: { $price }

### DEBUG / FALLBACK ###

virus-evolution-unknown-symptom = Неизвестный симптом
virus-evolution-unknown-body = Неизвестное тело
