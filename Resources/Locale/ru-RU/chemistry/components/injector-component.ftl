...
injector-toggle-verb-text = Переключить на режим ввода

## Entity

injector-component-inject-mode-name = Введение
injector-component-draw-mode-name = Забор
injector-component-dynamic-mode-name = Забор/Ввод
injector-component-mode-changed-text = Установлен {$mode}
injector-component-transfer-success-message = Вы вводите {$amount}ед. в {$target}.
injector-component-transfer-success-message-self = Вы вводите {$amount}ед. в себя.
injector-component-inject-success-message = Вы ввели {$amount}ед. в {$target}!
injector-component-inject-success-message-self = Вы ввели {$amount}ед. в себя!
...
injector-component-cannot-toggle-dynamic-message = Нельзя включить Забор/Ввод!
...
injector-component-cannot-transfer-message = У вас нет возможности ввести в {$target}!
injector-component-cannot-transfer-message-self = У вас нет возможности ввести в себя!
...
injector-component-cannot-draw-message = Вы не можете начать забор из {$target}!
injector-component-cannot-draw-message-self = Вы не можете начать забор из себя!
