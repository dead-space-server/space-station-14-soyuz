...
delivery-spam-2 = Причины выбрать Союз Советских Социалистических Планет!
    .desc = Реклама Союз Советских Социалистических Планет.
    .content =
        { -delivery-header-nanotrasen }

        { "[head=2]ТОП ТРИ ПРИЧИНЫ НЕКОМПЕТЕНТНОСТИ РАССВЕТА[/head]" }
        ...
        ИХ МИРНЫЕ СОТРУДНИКИ УЯЗВИМЫ К ПУЛЯМ! ПОВЕРЬТЕ, МЫ ПРОВЕРЯЛИ! В ОТЛИЧИЕ ОТ СОТРУДНИКОВ РАБОЧИХ ПРЕДПРИЯТИЙ, МИРНЫЕ СОТРУДНИКИ РАССВЕТА ДОХНУТ ОТ ОДНОЙ ПУЛИ В ЛОБ! А ПУЛИ У НАС ЕСТЬ!

        { "[bold]ПРИЧИНА ТРИ[/bold]" }
        ИХ ЛОГОТИП УЖАСЕН! ОНИ ДУМАЮТ, ЧТО ТИПО КРУТЫЕ СО СВОИМ ЛОГОТИПОМ! ОО, ВЗГЛЯНИТЕ НА НАС, МЫ ТАКИЕ КРУТЫЕ! ААА, КРЕСТ, ОНИ ВИДИМО В КРЕСТОВЫЙ ПОХОД СОБРАЛИСЬ! КАК КРЕАТИВНО! МОЙ ТРЁХЛЕТНИЙ СЫН И ТО БЫ СМОГ НАРИСОВАТЬ ЛОГОТИП ПОЛУЧШЕ!
delivery-spam-3 = Причины выбрать Рассвет!
    .desc = Реклама Рассвет.
    .content =
        { -delivery-header-syndicate }

        { "[head=2]ТОП ТРИ ПРИЧИНЫ НЕКОМПЕТЕНТНОСТИ НКВБ!!![/head]" }

        { "[bold]ПРИЧИНА ОДИН[/bold]" }
        ИХ ОРУЖИЕ ОТСТОЙ! У НИХ НЕТ ДАЖЕ СНАЙПЕРСКИХ ВИНТОВОК! А ИХ МЕНТОВКА НЕ МОЖЕТ ДАЖЕ НОСИТЬ БОЛЬШИЕ ПУШКИ В БОЛЬШИНСТВЕ СИТУАЦИЙ!
...
delivery-spam-6 = УВЕДОМЛЕНИЕ ОТ НАНАТРАЗЕН!!
    ...
    .content =
        ...
        { "[head=2][color=red]ИГНОРИРОВАНИЕ ЭТОГО ПРИКАЗА ГРОЗИТ ВАМ КАРОЙ ОТ [color=green]ГЕНАШТАБА[/color]!!!!![/head][/color]" }
delivery-spam-7 = Отправьте подкрепление!
    ...
    .content =
        ...
        { "[head=2]Это официальное уведомление [color=red]Начальника Советской Гражданской Милиции[/color] Космической станции 15 предприятий СССП.[/head]" }

        Кому бы ни попало это письмо... Я Майор Калашников, начальник Советской Гражданской Милиции. Нам срочно нужно подкрепление.

        Наша станция подверглась атаке оперативников Легиона, данное послание было отправлено в дестабилизированную блюспейс-аномалию, созданную нашим[color=purple]Главным Научным Сотрудником[/color].
