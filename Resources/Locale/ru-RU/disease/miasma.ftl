...
perishable-2 = [color=yellow]{ CAPITALIZE(OBJECT($target)) } тело выглядит не особо свежим.[/color]
perishable-3 = [color=orangered]{ CAPITALIZE(OBJECT($target)) } тело выглядит совсем не свежим.[/color]
perishable-4 = [color=red]{ CAPITALIZE(OBJECT($target)) } тело выглядит почти сгнившим.[/color]
perishable-1-nonmob = [color=green]{ CAPITALIZE(SUBJECT($target)) } выглядит ещё свежо.[/color]
perishable-2-nonmob = [color=yellowred]{ CAPITALIZE(SUBJECT($target)) } выглядит не особо свежо.[/color]
perishable-3-nonmob = [color=orangered]{ CAPITALIZE(SUBJECT($target)) } выглядит не особо свежо.[/color]
perishable-4-nonmob = [color=red]{ CAPITALIZE(SUBJECT($target)) } выглядит не особо свежо.[/color]
