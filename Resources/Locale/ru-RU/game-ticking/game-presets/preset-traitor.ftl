...
traitor-role-greeting =
    Вы - контрактный агент организации { $corporation }.
...
traitor-role-codewords =
    ...
    { $codewords }.[/color]
    Кодовые слова можно использовать в обычном разговоре, чтобы незаметно идентифицировать себя для других контрактных агентов.
