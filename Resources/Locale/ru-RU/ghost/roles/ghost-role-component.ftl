...
ghost-role-information-SyndiCat-description = Вы — верный дрессированный питомец Легионеров с микробомбой. Служите своему хозяину до самой смерти!
...
ghost-role-information-blueshieldofficer-description = Вы - Элитный оперативник Комитета ГосБезопасности. Ваша задача защищать членов Генерального Штаба и выполнять их приказы. Защищайте их ценой своей жизни! Также вы обладаете всеми навыками.
ghost-role-information-centcomofficer-name = Офицер Генерального Штаба
ghost-role-information-centcomofficer-description = Вы - Офицер Генерального Штаба. Вы должны защищать довереное вам место на котором вы появились и выполнять приказы вышестоящих сотрудников Центрального Командования.
...
ghost-role-information-ert-centcom-official-description =
    Вы — Офицер Генерального Штаба, направленный для инспекции станции по чрезвычайной ситуации.
