...
guide-entry-cargo = Почтовое отделение
guide-entry-cargo-bounties = Запросы Почтового отделения
...
guide-entry-service = Сервисный отдел
...
guide-entry-nuclear-operatives = Легионеры
guide-entry-traitors = Предатели
guide-entry-zombies = Зомби
guide-entry-revolutionaries = Контрреволюционеры
