...
roles-antag-syndicate-agent-name = Контрактный агент
roles-antag-syndicate-agent-objective = Выполните свои задачи и не попадитесь.
roles-antag-syndicate-agent-sleeper-name = Спящий контрактный агент
roles-antag-syndicate-agent-sleeper-objective = Разновидность контрактного агента, который может активироваться и начать действие в любой момент смены.
