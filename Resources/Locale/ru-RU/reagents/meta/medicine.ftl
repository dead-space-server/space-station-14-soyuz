...
reagent-name-derytracine = деритрацин
reagent-desc-derytracine = Особая смесь лекарственных препаратов, которая используется для лечения смешанных повреждений.
