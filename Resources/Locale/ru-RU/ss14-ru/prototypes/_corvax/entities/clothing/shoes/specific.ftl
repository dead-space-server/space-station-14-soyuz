...
ent-ClothingShoesCentcomBlack = обувь генерала специальных операций
    .desc = Кожаная, чёрная, высококачественная обувь, имеет технологические шипы, улучшающие сцепление с полом. Обувь высокопоставленных лиц НКВБ, вряд ли найти подобные на чёрном рынке...
