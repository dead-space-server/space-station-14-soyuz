...
ent-CrateMindShieldImplants = ящик имплантов Защиты-разума
    .desc = Ящик, содержащий три импланта Защиты-разума.
ent-CrateMedicalSurgery = ящик хирургических инструментов
    .desc = АБСОЛЮТНЫЙ ХИТ ПРОДАЖ! НАЛЕТАЙ И ПОКУПАЙ ХИРУРГИЧЕСКИЕ ИНСТРУМЕНТЫ!
...
ent-CrateBodyBags = ящик мешков для тела
    .desc = Содержит десять мешков тела. Зачем вам столько?...
ent-CrateVirologyBiosuit = ящик вирусологических биозащитных костюмов
    .desc = Содержит два костюма биологической защиты, чтобы никакая зараза не отвлекала вас от лечения экипажа. Чтобы открыть, необходим медицинский уровень доступа.
    .suffix = Защищённый
