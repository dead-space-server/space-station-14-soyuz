...
ent-GunSafeRifleLecter = оружейный сейф Лектеров
    .suffix = Лектер
    .desc = { ent-GunSafe.desc }
ent-GunSafeSubMachineGunDrozd = оружейный сейф пистолетов-пулемётов ОЦ-14 "Гроза"
    .suffix = Гроза
    .desc = { ent-GunSafe.desc }
ent-GunSafeShotgunEnforcer = оружейный сейф Силовиков
    .suffix = Силовик
    .desc = { ent-GunSafe.desc }
ent-GunSafeShotgunKammerer = оружейный сейф МР-153
    .suffix = МР-153, Каммерер
    .desc = { ent-GunSafe.desc }
...
ent-GunSafeDominator = оружейный сейф доминаторов
    .suffix = Доминатор
    .desc = { ent-GunSafe.desc }
ent-GunSafeArmorHeavy = сейф с тяжёлым бронекостюмом
    .suffix = Тяжёлый бронекостюм
    .desc = { ent-GunSafe.desc }
