...
ent-XenoborgMaterialBag = Хранилище материалов ксеноборга
    .desc = Аматорская версия блюспейс сумки, позволяющая собирать некоторые материалы, непригодная для использования гуманоидами из-за вредных выбросов
