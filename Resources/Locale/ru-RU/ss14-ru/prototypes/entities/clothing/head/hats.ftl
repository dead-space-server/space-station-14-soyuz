...
ent-ClothingHeadHatBeretWarden = берет старшего следователя
    .desc = Фирменный голубой берет с эмблемой старшего следователя. Для милиционеров, которые предпочитают стиль безопасности.
...
ent-ClothingHeadHatWarden = фуражка старшего следователя
