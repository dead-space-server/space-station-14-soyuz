...
ent-ClothingHeadHelmetERTSecurity = шлем офицера безопасности СОБР
    .desc = Атмосферный шлем, который носят офицеры специальных отрядов быстрого реагирования СССП. Имеет красный фонарь.
ent-ClothingHeadHelmetHelmet = шлем лидера СОБР
    .desc = Атмосферный шлем, который носит лидер специальных отрядов быстрого реагирования СССП. Имеет синий фонарь.
