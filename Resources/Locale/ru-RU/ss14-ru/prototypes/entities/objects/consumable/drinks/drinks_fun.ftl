...
ent-BottomlessLube = редспейс мензурка смазки
    .desc = Эта аномальная редспейс мензурка бесконечно производит космическую смазку, поэтому её стоит тщательно охранять, чтобы она не попала не в те руки.
    .suffix = ДЕБАГ
