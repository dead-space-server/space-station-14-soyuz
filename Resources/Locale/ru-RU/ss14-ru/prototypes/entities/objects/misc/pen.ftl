...
ent-PenIAA = ручка Агента Внутренних Дел
    .desc = Элегантная перьевая ручка для агента внутренних дел. Дорогая и модная, которой Вы достойны обладать только в том случае, если умеете работать с огромным количеством бумаг.
