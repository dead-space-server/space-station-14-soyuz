...
# DS14-value: "электрическая проволочная щётка" -> "электрощётка"
ent-WireBrushElectrical = электрощётка
    .desc = Жёсткая проволочная щётка из стали, уборка будет ещё легче!
