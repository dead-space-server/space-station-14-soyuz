...
ent-AnomalyScannerAdmin = { ent-AnomalyScanner }
    .desc = Ручной сканер, предназначенный для получения информации о различных аномальных объектах. У него есть несколько дополнительных функций.
