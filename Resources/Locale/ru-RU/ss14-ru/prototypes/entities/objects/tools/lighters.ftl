...
ent-CentCommFlippo = позолоченная флиппо Генерального Штаба
    .desc = Изысканная флиппо, с рельефным, нефритовым с позолотой корпусом, турбо-пламя которой создаётся редспейсом. Кнопка защищена миниатюрным считывателем доступов, который реагирует только на сотрудников Генерального Штаба. Самая красивая зажигалка, известная человечеству.
    .suffix = НЕ МАППИТЬ
...
ent-FlippoSyndicateLighter = зажигалка с гравировкой Рассвета
    .desc = Прочная металлическая зажигалка, может работать довольно долго. Логотип Рассвета не поможет вам в стычке с ОБР.
