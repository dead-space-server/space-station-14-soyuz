...
ent-CentCommFlippo = позолоченная флиппо Генерального Штаба
    .desc = Изысканная флиппо, с рельефным, нефритовым с позолотой корпусом, турбо-пламя которой создаётся блюспейсом. Кнопка защищена миниатюрным считывателем доступов, который реагирует только на сотрудников Генерального Штаба. Самая красивая зажигалка, известная человечеству.
    .suffix = НЕ МАППИТЬ
