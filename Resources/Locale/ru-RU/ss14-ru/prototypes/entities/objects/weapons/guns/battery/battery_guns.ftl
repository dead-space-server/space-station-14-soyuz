...
ent-WeaponPulsePistol = импульсный пистолет
    .desc = Новейший энергетический пистолет, предпочитаемый оперативниками СОБР в качестве запасного оружия.
    .suffix = Пистолет
ent-WeaponPulseCarbine = импульсный карабин
    .desc = Высокотехнологичный энергетический карабин, который предпочитают оперативники СОБР.
    .suffix = Винтовка
...
ent-WeaponTaserSuper = элитный тазер
    .desc = Электрошокер малой ёмкости, используемый элитной НКВБ для обезвреживания даже самых стойких целей.
    .suffix = Адмемы
