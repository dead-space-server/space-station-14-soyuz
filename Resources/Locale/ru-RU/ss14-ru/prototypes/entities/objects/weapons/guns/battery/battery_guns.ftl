...
ent-WeaponLaserCarbine = лазерный карабин
    .desc = Предпочитается милицией за дешевизну и простоту использования.
    .suffix = Винтовка
...
ent-WeaponPulseCarbine = импульсный карабин
    .desc = Высокотехнологичный энергетический карабин, который предпочитают оперативники СОБР НКВБ.
    .suffix = Винтовка
