...
ent-WeaponSubMachineGunC20r = C-20r
    ...
    .suffix = Пистолет-пулемёт
ent-WeaponSubMachineGunC20rROW = ОЦ-94 "Гроза"
    .desc = Превосходный, полностью автоматический, штурмовой автомат. Использует патроны калибра 9х19 мм. Принят на вооружение в 2694-ом году.
