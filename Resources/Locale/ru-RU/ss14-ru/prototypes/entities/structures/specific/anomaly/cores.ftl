...
ent-AnomalyCoreSantaInert = { ent-BaseAnomalyInertCore }
    ...
    .desc = { ent-BaseAnomalyInertCore.desc }
ent-AnomalyCoreNecroInert = { ent-BaseAnomalyInertCore }
    .suffix = Некро, Инертное
    .desc = { ent-BaseAnomalyInertCore.desc }
