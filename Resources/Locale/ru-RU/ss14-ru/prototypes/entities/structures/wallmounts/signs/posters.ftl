...
ent-PosterContrabandFreeDrone = Дроны не рабы
    .desc = Этот плакат посвящён храбрости дрона-изменника, однажды изгнанного, а затем окончательно уничтоженного силами НКВБ.
...
ent-PosterLegitBotanyFear = Ужас гидропоники
...
ent-PosterLegitHereForYourSafety = Здесь для вашей безопасности
    .desc = Плакат, восхваляющий Советскую Гражданскую Милицию станции.
...
ent-PosterLegitSafetyReport = Техника безопасности: донесения
    .desc = Плакат, инструктирующий зрителя сообщать о подозрительной активности в НКВБ.
ent-PosterLegitReportCrimes = Сообщайте о преступлениях!
    .desc = Плакат, призывающий оперативно сообщать о преступлениях или подстрекательских действиях в НКВБ.
...
ent-PosterLegitOppenhopper = Опергеймер
    .desc = Плакат давно забытого фильма. В нём рассказывается о группе упорных салаг из сектора "Мейн", которые противостоят атакам печально известных Легионеров. Слоган гласит: "Атаки оперативников будут продолжаться, пока робастность не повысится".
