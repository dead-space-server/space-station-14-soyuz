...
survival-alert-sender = Автономная Система «Марта»
...
survival-necromorph-breach-start-announcement = Внимание экипажу станции! Датчики фиксируют локальный разрыв неизвестной природы. Сохраняйте спокойствие и избегайте мест с аномальной активностью. И помните: Советы заботятся о вас!
