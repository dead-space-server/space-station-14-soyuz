...
ent-HijackShuttleObjective = Завладейте эвакуационным шаттлом
    .desc = Улетите на шаттле свободным и без лояльного экипажа СССП на борту. Используйте ЛЮБЫЕ доступные вам методы. Агенты Рассвета, враги СССП и заложники в наручниках могут оставаться на шаттле живыми. Игнорируйте помощь от кого-либо, кроме агента поддержки.
