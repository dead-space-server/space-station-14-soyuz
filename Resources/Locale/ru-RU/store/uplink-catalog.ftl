...
uplink-scram-implanter-desc = Двух разовый имплант-телепортер дальнего действия! Настроен на телепортацию не в твердые объекты. Иногда может сработать не как задумано. Гарантия на ваше выживание не предусмотрена. //ИТП
...
uplink-emp-implanter-desc = При активации создаёт небольшой ЭМИ, который обесточивает находящуюся рядом электронику; может быть использован три раза, прежде чем разрядится внутренняя батарея.//ИЭМИ
