...
ui-vote-gamemode-runoff = Ничья между режимами: { $modes }. Запущено новое голосование на { $seconds } секунд.
ui-vote-gamemode-tie-timeout = Не хватает времени на новое голосование из-за скорой генерации карты. Случайно выбран режим: { $picked }
